...
(function () {
    'use strict';
    angular.module('YC.Ionic.UI').component('twZipCode', twZipCode());

    function twZipCode() {
        return {
            template: ' <button class="button button-stable"  modal-select="" on-select="Ctrl.ChangeCounty()" ng-model="Ctrl.county" options="Ctrl.countyOption" modal-title="請選擇縣市" has-search="true" use-collection-repeat="false">' +
                              '{{Ctrl.zipcode}}{{Ctrl.county || "選擇縣市"}}' +
                              '<div class="option">' +
                                '{{option}}' +
                              '</div>' +
                            '</button>' +
                            '<button class="button button-stable" modal-select="" ng-model="Ctrl.shortAddress" options="Ctrl.districtOption" modal-title="請選鄉鎮區" has-search="true" use-collection-repeat="false">' +
                              '{{Ctrl.district || "選擇鄉鎮區"}}' +
                              '<div class="option">' +
                                '<h2>{{option.Name}}</h2>'+
                                '<p>{{option.ID}}</p>'+
